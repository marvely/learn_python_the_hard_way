...
# refactor map with all the rooms from exer43
central_corridor = Room("Central Corridor",
'''
The Gothons of Plannet Percal #25 have invaded your ship and destroyed your entire crew. You are the last surviving member and your last mission is to get the neutron destruct bomb from the Weapon Armory, put it in the bridge, and blow the ship up after getting into an escape pod.
...
'''
You jump into a random pod and hit the eject button. The pod excapes out into the void of space, then implodes as the hull ruptures, crushing your body into jam jelly.
''')
...
# this need to be changed and add all the original ways of death according to the room in exer43.
...
laser_weapon_armory.add_paths({
    '0132': the_bridge,
    '*': generic_death # "catch-all" action in the engine.
})
